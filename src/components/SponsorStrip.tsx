      ...
      <div className="shell py-6">
        <div className="flex flex-col sm:flex-row items-center sm:items-start justify-center flex-wrap gap-x-12 gap-y-6">
          {PARTNERS.map((p) => (
            ...
            >
              <span className="font-mono text-[11px] font-bold tracking-[0.22em] uppercase text-[var(--faint)] group-hover:text-[var(--accent)] transition-colors">
                {p.tier}
              </span>
          ...
          <a
            ...
            className="font-mono text-[13px] font-bold tracking-[0.16em] uppercase text-[var(--muted)] hover:text-[var(--accent)] transition-colors whitespace-nowrap"
            onMouseEnter={() => sound.playHover()}
          >
            See all partners →
          </a>
